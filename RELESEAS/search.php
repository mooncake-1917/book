...
<head>
    ...
    <title>搜索知识-<?php echo $esc_key; ?></title>
        ...
        if ($search_key === '' || strlen($search_key) > 200) {
            ...
            foreach ($dirs as $dir) {
                ...
                foreach (scandir($dirReal) as $it) {
                    ...
                    if (strtolower(pathinfo($it, PATHINFO_EXTENSION)) !== 'md') continue;
                    $items[] = $it;
                }
                ...
                foreach ($items as $item) {
                    ...
                    $search_bool = true;
                    echo "<div class=\"search-item\">";
                    echo "<div class=\"search-item-title\">" . e($item) . "</div>";
                    echo "<div class=\"search-item-link\">&gt;&gt;&nbsp;" . e($dir) . "&nbsp;&gt;&nbsp;" . e($item) . "</div>";
                    ...
                    foreach ($lines as $line) {
                        ...
                        $shown++;
                        $esc_line = e($line);
                        echo "<p>" . str_replace($esc_key, $hl, $esc_line) . "</p>";
                    }
